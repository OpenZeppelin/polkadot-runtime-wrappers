...
macro_rules! impl_openzeppelin_xcm {
    ($t:ty) => {
        ...
        impl pallet_message_queue::Config for Runtime {
            ...
            // Page/heap size type.
            type Size = u32;
            // Weight information for extrinsics in this pallet. Rerun benchmarks if you are making changes to runtime configuration.
        ...
        impl cumulus_pallet_xcmp_queue::Config for Runtime {
            ...
            // Benchmark results should be updated if any runtime changes affect performance.
        ...
        impl pallet_xcm::Config for Runtime {
            ...
            type Weigher = FixedWeightBounds<UnitWeightCost, RuntimeCall, MaxInstructions>;
            // Provides weight information for extrinsics in the pallet.
